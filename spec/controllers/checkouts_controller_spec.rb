...
RSpec.describe CheckoutsController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all checkouts as @checkouts" do
      ...
      expect(assigns(:checkouts)).to eq([checkout])
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created checkout as @checkout" do
        ...
        expect(assigns(:checkout)).to be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved checkout as @checkout" do
        post :create, {:checkout => invalid_attributes}, valid_session
        expect(assigns(:checkout)).to be_a_new(Checkout)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested checkout" do
        checkout = Checkout.create! valid_attributes
        put :update, {:id => checkout.to_param, :checkout => new_attributes}, valid_session
        checkout.reload
    ...
    describe "with invalid params" do
      it "assigns the checkout as @checkout" do
        checkout = Checkout.create! valid_attributes
        put :update, {:id => checkout.to_param, :checkout => invalid_attributes}, valid_session
        expect(assigns(:checkout)).to eq(checkout)
      end
